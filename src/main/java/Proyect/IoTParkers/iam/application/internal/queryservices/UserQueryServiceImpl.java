package Proyect.IoTParkers.iam.application.internal.queryservices;

import Proyect.IoTParkers.iam.domain.model.aggregates.User;
import Proyect.IoTParkers.iam.domain.model.queries.GetAllUsersQuery;
import Proyect.IoTParkers.iam.domain.model.queries.GetUserByIdQuery;
import Proyect.IoTParkers.iam.domain.model.queries.GetUserByUsernameQuery;
import Proyect.IoTParkers.iam.domain.model.queries.UserQueryService;
